...
.. [#monogenic-ftn] The monogenic curvelet transform was originally defined for 2D signals by Storath 2010, but this implementation extends it to arbitrary ND signals by using all Riesz transform components (one per dimension).
