...
class UDCT:
    ...
    def _vect_real(
        self, coefficients: UDCTCoefficients[C]
    ...
    def _backward_real(self, coefficients: UDCTCoefficients[C]) -> np.ndarray:
    ...
    def _backward_complex(self, coefficients: UDCTCoefficients[C]) -> np.ndarray:
