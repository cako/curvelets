...
def _window_computation(
    ...
    This function generates the frequency-domain windows used in the Uniform
    ...
    >>>
    >>> # Compute windows
    >>> windows, decimation_ratios, indices = _window_computation(params)
    >>>
    >>> # Check structure
